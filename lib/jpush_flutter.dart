...
class JPush {
  ...
  EventHandler? _didFailToRegisterForRemoteNotification;
  ...
  void addEventHandler({
    ...
    EventHandler? didFailToRegisterForRemoteNotification,
  }) {
    ...
    _didFailToRegisterForRemoteNotification = didFailToRegisterForRemoteNotification;
  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "didFailToRegisterForRemoteNotification":
        return _didFailToRegisterForRemoteNotification!(call.arguments.cast<String, dynamic>());
      default:
